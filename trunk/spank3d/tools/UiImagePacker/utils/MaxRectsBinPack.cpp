...
Rect MaxRectsBinPack::Insert(int width, int height, FreeRectChoiceHeuristic method, bool allowRotate)
{
	Rect newNode;
	...
	switch(method)
	{
		case RectBestShortSideFit: newNode = FindPositionForNewNodeBestShortSideFit(width, height, score1, score2, allowRotate); break;
		case RectBottomLeftRule: newNode = FindPositionForNewNodeBottomLeft(width, height, score1, score2, allowRotate); break;
		case RectContactPointRule: newNode = FindPositionForNewNodeContactPoint(width, height, score1, allowRotate); break;
		case RectBestLongSideFit: newNode = FindPositionForNewNodeBestLongSideFit(width, height, score2, score1, allowRotate); break;
		case RectBestAreaFit: newNode = FindPositionForNewNodeBestAreaFit(width, height, score1, score2, allowRotate); break;
	}
...
void MaxRectsBinPack::Insert(std::vector<RectSize> &rects, std::vector<Rect> &dst, FreeRectChoiceHeuristic method, bool allowRotate)
{
	dst.clear();
	...
	while(rects.size() > 0)
	{
		...
		for(size_t i = 0; i < rects.size(); ++i)
		{
			int score1;
			int score2;
			Rect newNode = ScoreRect(rects[i].width, rects[i].height, method, score1, score2, allowRotate);
...
Rect MaxRectsBinPack::ScoreRect(int width, int height, FreeRectChoiceHeuristic method, int &score1, int &score2, bool allowRotate) const
{
	Rect newNode;
	...
	case RectBestShortSideFit: newNode = FindPositionForNewNodeBestShortSideFit(width, height, score1, score2, allowRotate); break;
	case RectBottomLeftRule: newNode = FindPositionForNewNodeBottomLeft(width, height, score1, score2, allowRotate); break;
	case RectContactPointRule: newNode = FindPositionForNewNodeContactPoint(width, height, score1, allowRotate); 
...
Rect MaxRectsBinPack::FindPositionForNewNodeBottomLeft(int width, int height, int &bestY, int &bestX, bool allowRotate) const
{
	Rect bestNode;
...
Rect MaxRectsBinPack::FindPositionForNewNodeBestShortSideFit(int width, int height, int &bestShortSideFit, int &bestLongSideFit, bool allowRotate) const
{
	Rect bestNode;
	memset(&bestNode, 0, sizeof(Rect));
...
Rect MaxRectsBinPack::FindPositionForNewNodeBestLongSideFit(int width, int height, int &bestShortSideFit, int &bestLongSideFit, bool allowRotate) const
{
	Rect bestNode;
	memset(&bestNode, 0, sizeof(Rect));
...
Rect MaxRectsBinPack::FindPositionForNewNodeBestAreaFit(int width, int height, int &bestAreaFit, int &bestShortSideFit, bool allowRotate) const
{
	Rect bestNode;
	memset(&bestNode, 0, sizeof(Rect));
...
Rect MaxRectsBinPack::FindPositionForNewNodeContactPoint(int width, int height, int &contactScore, bool allowRotate) const
{
	Rect bestNode;
	memset(&bestNode, 0, sizeof(Rect));
