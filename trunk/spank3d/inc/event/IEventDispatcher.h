...
public:
	...
	typedef std::multimap<tstring, EVENT_HANDLER> TM_EVENT_HANDLER;
...
public:
	...
	void RegisterEvent(const tstring& strId, IEventDispatcher* pHandler, FUNC_HANDLER pFunc);
	void UnregisterEvent(const tstring& strId, IEventDispatcher* pHandler, FUNC_HANDLER pFunc);
